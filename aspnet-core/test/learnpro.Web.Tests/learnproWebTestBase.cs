...
{
    public abstract class learnproWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static learnproWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(learnproWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<learnproDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<learnproDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<learnproDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<learnproDbContext, Task<T>> func)
        {
            T result;
